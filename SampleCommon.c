...
/*
	I originally generated the "WakerPrompts.strings" file by running 
    ...
    CFCopyLocalizedStringFromTableInBundle(CFSTR("GetUIDsPrompt"),          "WakerPrompts", b, "prompt included in authorization dialog for the GetUIDs command")
    CFCopyLocalizedStringFromTableInBundle(CFSTR("LowNumberedPortsPrompt"), "WakerPrompts", b, "prompt included in authorization dialog for the LowNumberedPorts command")
*/
...
const BASCommandSpec kWakerCommandSet[] = {
    {	kWakerSetWakeupEventCommand,         // commandName
        ...
        "WakeAuthorizationPrompt",				// rightDescriptionKey -- key for custom prompt in "WakerPrompts.strings
        NULL                                    // userData
	},
